...
public class NewsStyle2Adapter extends BaseAdapter{
    private Context context;
    private ArrayList<NewsStyle2Model> menuData;
    private LayoutInflater mInflater;

    public NewsStyle2Adapter(Context ctx, ArrayList<NewsStyle2Model> data){
        context = ctx;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ViewHolder holder;
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.row_news2, null);
