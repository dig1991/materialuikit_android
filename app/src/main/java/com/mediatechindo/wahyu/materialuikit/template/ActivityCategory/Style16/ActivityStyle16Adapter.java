 ...
 */
public class ActivityStyle16Adapter extends RecyclerView.Adapter<ActivityStyle16Adapter.ItemViewHolder> {
    private static ArrayList<ActivityStyle16Model> dataList;
    private LayoutInflater mInflater;
    private Context context;

    public ActivityStyle16Adapter(Context ctx, ArrayList<ActivityStyle16Model> data) {
        context = ctx;
        dataList = data;
    ...
    public ItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_activity16, parent, false);
