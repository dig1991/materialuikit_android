package com.mediatechindo.wahyu.materialuikit.template.LoginSignupCategory.Style7;
...
public class LoginSignupStyle7Activity extends AppCompatActivity implements View.OnClickListener{
    private static final String[] pageTitle = {"SIGN UP","SIGN IN"};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.loginsignup7_layout);
        ...
        TabLayout tabLayout = (TabLayout) findViewById(R.id.tab_layout_loginsignup7);
        ViewPager viewPager = (ViewPager) findViewById(R.id.viewpager_loginsignup7);
    ...
    public class LoginSignup4Adapter extends FragmentPagerAdapter {
        ...
        public LoginSignup4Adapter(FragmentManager fm){
            ...
            fragments.add(new LoginSignupStyle7Fragment());
            fragments.add(new LoginSignupStyle7Fragment());
        }
        @Override
