...
public class ExtraLeftMenuSocialAdapter extends BaseAdapter{
    private Context context;
    private ArrayList<ExtraLeftMenuSocialModel> menuData;
    private LayoutInflater mInflater;

    public ExtraLeftMenuSocialAdapter(Context ctx, ArrayList<ExtraLeftMenuSocialModel> data){
        context = ctx;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ViewHolder holder;
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.row_extra_leftmenu_social, null);
