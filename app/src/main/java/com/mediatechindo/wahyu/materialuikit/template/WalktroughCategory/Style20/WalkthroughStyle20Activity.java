package com.mediatechindo.wahyu.materialuikit.template.WalktroughCategory.Style20;
...
public class WalkthroughStyle20Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.walkthrough20_layout);
    ...
    private class ViewPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            return new WalkthroughStyle20Fragment(position);
        }
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.btnGetStarted:
                ...
                break;
            case R.id.btnClose:
                Toast.makeText(this, "Button Close clicked!", Toast.LENGTH_SHORT).show();
                break;
            default:
                break;
        }
