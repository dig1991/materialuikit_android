...
public class WalkthroughStyle6Page4 extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ((WalkthroughStyle6Activity) getActivity()).setImageFragment4(img);
    ...
    public void onResume() {
        super.onResume();
        Log.d(TAG, "onResume: page 4");
    }

    @Override
    public void onPause() {
        super.onPause();
        Log.d(TAG, "onPause: page 4");
    }
}
