...
public class MenuNavigation13Adapter extends BaseAdapter{
    private Context context;
    private ArrayList<MenuNavigation13Model> menuData;
    private LayoutInflater mInflater;

    public MenuNavigation13Adapter(Context ctx, ArrayList<MenuNavigation13Model> data){
        context = ctx;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ViewHolder holder;
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.row_menunavigation13, null);
