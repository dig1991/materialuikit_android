package com.mediatechindo.wahyu.materialuikit.template.ActivityCategory.Style16;
...
public class ActivityStyle16Activity extends AppCompatActivity implements View.OnClickListener{
    ArrayList<ActivityStyle16Model> rowListItem;
    ActivityStyle16Adapter rcAdapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity16_layout);
        ...
        rcAdapter = new ActivityStyle16Adapter(this, rowListItem);
        rView.setAdapter(rcAdapter);
    }

    private ArrayList<ActivityStyle16Model> getAllItemList(){
        ArrayList<ActivityStyle16Model> allItems = new ArrayList<>();
        ActivityStyle16Model dt;

        dt = new ActivityStyle16Model("profile/style-3/Profile-3-friend3.png","Tony Ramirez", "Nice photo");
        allItems.add(dt);
        dt = new ActivityStyle16Model("profile/style-3/Profile-3-friend3.png","Ludwig", "I love how you took it on white");
        allItems.add(dt);
        dt = new ActivityStyle16Model("profile/style-3/Profile-3-friend2.png","Christina", "You're awesome!");
        allItems.add(dt);
        dt = new ActivityStyle16Model("profile/style-3/Profile-3-friend3.png","Remi Boucher", "Wow!");
        allItems.add(dt);
        dt = new ActivityStyle16Model("profile/style-3/Profile-3-friend3.png","Tony Ramirez", "Nice photo");
        allItems.add(dt);
        dt = new ActivityStyle16Model("profile/style-3/Profile-3-friend3.png","Ludwig", "I love how you took it on white");
