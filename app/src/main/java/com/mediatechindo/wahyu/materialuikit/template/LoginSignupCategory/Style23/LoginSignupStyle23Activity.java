package com.mediatechindo.wahyu.materialuikit.template.LoginSignupCategory.Style23;
...
public class LoginSignupStyle23Activity extends AppCompatActivity implements View.OnClickListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.loginsignup23_layout);
