package com.mediatechindo.wahyu.materialuikit.template.ProfileCategory.Style26;
...
public class ProfileStyle26Activity extends AppCompatActivity implements View.OnClickListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.profile26_layout);
    ...
    public void onClick(View view) {
        switch (view.getId()){
            ...
            case R.id.button4:
                ...
                break;
            case R.id.button5:
                Toast.makeText(this, "button friends clicked!", Toast.LENGTH_SHORT).show();
                break;
            case R.id.button6:
