...
public class GalleryStyle7Activity extends AppCompatActivity implements View.OnClickListener {
    private static final String[] pageTitle = {"PHOTO","VIDEO","DOCUMENT"};
    private TextView titleBar;
    private GalleryStyle7RecentAdapter rcAdapterRecent;
    private ArrayList<GalleryStyle7RecentModel> itemSelected;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.gallery7_layout);
    ...
    public void setDataSelected(GalleryStyle7RecentAdapter adapter, ArrayList<GalleryStyle7RecentModel> listData){
        rcAdapterRecent = adapter;
    ...
    private void deleteItem() {
        if (itemSelected.size() == 0) {
            ...
            for (GalleryStyle7RecentModel dt : itemSelected) {
                rcAdapterRecent.deleteItem(dt.getId());
            }
            itemSelected.clear();
            updateTitleText("Gallery");
        }
    }
    ...
    private class ViewPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            return new GalleryStyle7Fragment(position);
        }
