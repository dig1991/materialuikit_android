...
public class WalkthroughStyle6Page2 extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ((WalkthroughStyle6Activity) getActivity()).setImageFragment2(img);
    ...
    public void onResume() {
        super.onResume();
        Log.d(TAG, "onResume: page 2");
    }

    @Override
    public void onPause() {
        super.onPause();
        Log.d(TAG, "onPause: page 2");
    }
}
