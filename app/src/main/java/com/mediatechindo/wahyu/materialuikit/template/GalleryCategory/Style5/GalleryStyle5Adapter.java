...
public class GalleryStyle5Adapter extends RecyclerView.Adapter<GalleryStyle5Adapter.ItemViewHolder> implements GalleryStyle5ItemTouchAdapter{
    private final List<String> mItems = new ArrayList<>();
    private final GalleryStyle5OnStartDragListener mDragStartListener;
    private int count = 1;
    private Context context;

    public GalleryStyle5Adapter(Context ctx, GalleryStyle5OnStartDragListener dragStartListener) {
    ...
    public ItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_gallery5, parent, false);
    ...
    public void onBindViewHolder(ItemViewHolder holder, int position) {
        ...
        String url = BuildConfig.IMAGE_URL + "gallery/style-5/Gallery-5-img-1.jpg";
        String urlThumb = BuildConfig.IMAGE_URL + "gallery/style-5/Gallery-5-img-1-thumb.jpg";
