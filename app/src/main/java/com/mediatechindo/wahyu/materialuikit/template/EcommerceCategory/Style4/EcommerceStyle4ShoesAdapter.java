 ...
 */
public class EcommerceStyle4ShoesAdapter extends RecyclerView.Adapter<EcommerceStyle4ShoesAdapter.ItemViewHolder> {
    private static ArrayList<EcommerceStyle4Model> dataList;
    private LayoutInflater mInflater;
    private Context context;
    private EcommerceStyle4ClickListener clicklistener = null;

    public EcommerceStyle4ShoesAdapter(Context ctx, ArrayList<EcommerceStyle4Model> data) {
        context = ctx;
        dataList = data;
    ...
    public class ItemViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            if (clicklistener != null) {
                clicklistener.itemShoesClicked(v, getAdapterPosition());
            }
        }
    }
