package com.mediatechindo.wahyu.materialuikit.template.LoginSignupCategory.Style19;
...
public class LoginSignupStyle19Activity extends AppCompatActivity implements View.OnClickListener {
    View bg;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.loginsignup19_layout);
        ...
        String url = BuildConfig.IMAGE_URL + "login-signup/style-19/Login-Register-19-960.jpg";
