package com.mediatechindo.wahyu.materialuikit.template.ExtraDesignCategory.TextLight;
...
public class ExtraTextLightActivity extends AppCompatActivity implements View.OnClickListener {
    private AlertDialog dialog;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.extra_text_light_layout);
