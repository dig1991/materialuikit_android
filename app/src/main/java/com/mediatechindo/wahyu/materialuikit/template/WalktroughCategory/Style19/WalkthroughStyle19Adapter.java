...
public class WalkthroughStyle19Adapter extends RecyclerView.Adapter<WalkthroughStyle19Adapter.ItemViewHolder> implements WalkthroughStyle19ItemTouchAdapter {
    private final List<String> mItems = new ArrayList<>();
    private final WalkthroughStyle19OnStartDragListener mDragStartListener;
    private int count = 1;
    private Context context;

    public WalkthroughStyle19Adapter(Context ctx, WalkthroughStyle19OnStartDragListener dragStartListener) {
    ...
    public ItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_walkthrough19, parent, false);
