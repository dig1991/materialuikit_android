 ...
 */
public class ActivityStyle26Adapter extends RecyclerView.Adapter<ActivityStyle26Adapter.ItemViewHolder> {
    private static ArrayList<ActivityStyle26Model> dataList;
    private LayoutInflater mInflater;
    private Context context;

    public ActivityStyle26Adapter(Context ctx, ArrayList<ActivityStyle26Model> data) {
        context = ctx;
        dataList = data;
    ...
    public ItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_activity26, parent, false);
