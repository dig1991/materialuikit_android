 ...
 */
public class EcommerceStyle22Adapter extends RecyclerView.Adapter<EcommerceStyle22Adapter.ItemViewHolder> {
    private static ArrayList<EcommerceStyle22Model> dataList;
    private LayoutInflater mInflater;
    private Context context;
    private EcommerceStyle22ClickListener clicklistener = null;

    public EcommerceStyle22Adapter(Context ctx, ArrayList<EcommerceStyle22Model> data) {
        context = ctx;
        dataList = data;
    ...
    public void setClickListener(EcommerceStyle22ClickListener listener) {
        this.clicklistener = listener;
    }

    @Override
    public ItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_ecommerce22, parent, false);
