...
public class GalleryStyle8Activity extends AppCompatActivity implements View.OnClickListener {
    private static final String[] pageTitle = {"PHOTO","VIDEO","DOCUMENT"};
    private TextView titleBar;
    private GalleryStyle8RecentAdapter rcAdapterRecent;
    private ArrayList<GalleryStyle8RecentModel> itemSelected;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.gallery8_layout);
    ...
    private class ViewPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            return new GalleryStyle8Fragment(position);
        }
