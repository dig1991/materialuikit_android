 ...
 */
public class ExtraDesignMenuAdapter extends RecyclerView.Adapter<ExtraDesignMenuAdapter.ViewHolder>{
    Activity activity;
    String[] datas;

    public ExtraDesignMenuAdapter(Activity act, String[] dt){
        this.activity = act;
        this.datas = dt;
    }
