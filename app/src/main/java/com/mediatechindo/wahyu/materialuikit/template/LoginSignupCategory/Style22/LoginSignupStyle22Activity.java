package com.mediatechindo.wahyu.materialuikit.template.LoginSignupCategory.Style22;
...
public class LoginSignupStyle22Activity extends AppCompatActivity implements View.OnClickListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.loginsignup22_layout);
