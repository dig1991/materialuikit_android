 ...
 */
public class WalkthroughMenuAdapter extends RecyclerView.Adapter<WalkthroughMenuAdapter.ViewHolder>{
    Activity activity;
    String[] datas;

    public WalkthroughMenuAdapter(Activity act, String[] dt){
        this.activity = act;
        this.datas = dt;
    }
