 ...
 */
public class GalleryStyle6NatureAdapter extends RecyclerView.Adapter<GalleryStyle6NatureAdapter.ItemViewHolder> {
    private static ArrayList<GalleryStyle6NatureModel> dataList;
    private LayoutInflater mInflater;
    private Context context;

    public GalleryStyle6NatureAdapter(Context ctx, ArrayList<GalleryStyle6NatureModel> data) {
        context = ctx;
        dataList = data;
