 ...
 */
public class GalleryStyle1CameraAdapter extends RecyclerView.Adapter<GalleryStyle1CameraAdapter.ItemViewHolder> {
    private static ArrayList<GalleryStyle1CameraModel> dataList;
    private LayoutInflater mInflater;
    private Context context;
    private GalleryStyle1CameraClickListener clicklistener = null;

    public GalleryStyle1CameraAdapter(Context ctx, ArrayList<GalleryStyle1CameraModel> data) {
        context = ctx;
        dataList = data;
    ...
    public void setClickListener(GalleryStyle1CameraClickListener listener) {
