...
public class ProfileStyle11Activity extends AppCompatActivity implements View.OnClickListener {
    private static final String[] pageTitle = {"PROFILE","PHOTOS","FRIENDS","STORIES"};
    ImageView bg;
    ...
    public class ProfileStyle1Adapter extends FragmentPagerAdapter {
        ...
        public ProfileStyle1Adapter(FragmentManager fm){
            ...
            fragments.add(new ProfileStyle11Tab1());
            fragments.add(new ProfileStyle11Tab2());
            fragments.add(new ProfileStyle11Tab3());
            fragments.add(new ProfileStyle11Tab4());
        }
        @Override
