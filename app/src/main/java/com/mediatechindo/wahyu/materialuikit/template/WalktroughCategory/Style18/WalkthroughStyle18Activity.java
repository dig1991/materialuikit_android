package com.mediatechindo.wahyu.materialuikit.template.WalktroughCategory.Style18;
...
public class WalkthroughStyle18Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.walkthrough18_layout);
    ...
    private class ViewPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            return new WalkthroughStyle18Fragment(position);
        }
