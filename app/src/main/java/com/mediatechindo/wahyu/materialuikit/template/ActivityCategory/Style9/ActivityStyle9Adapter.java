 ...
 */
public class ActivityStyle9Adapter extends RecyclerView.Adapter<ActivityStyle9Adapter.ItemViewHolder> {
    private static ArrayList<ActivityStyle9Model> dataList;
    private LayoutInflater mInflater;
    private Context context;

    public ActivityStyle9Adapter(Context ctx, ArrayList<ActivityStyle9Model> data) {
        context = ctx;
        dataList = data;
    ...
    public ItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_activity9, parent, false);
