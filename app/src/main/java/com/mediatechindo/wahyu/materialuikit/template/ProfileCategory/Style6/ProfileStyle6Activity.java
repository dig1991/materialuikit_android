...
public class ProfileStyle6Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.profile6_layout);
    ...
    public class ProfileStyle1Adapter extends FragmentPagerAdapter {
        ...
        public ProfileStyle1Adapter(FragmentManager fm){
            ...
            fragments.add(new ProfileStyle6Fragment());
            fragments.add(new ProfileStyle6Fragment());
            fragments.add(new ProfileStyle6Fragment());
        }
        @Override
