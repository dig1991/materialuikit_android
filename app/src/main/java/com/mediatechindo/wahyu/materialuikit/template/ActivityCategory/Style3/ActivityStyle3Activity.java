...
public class ActivityStyle3Activity extends AppCompatActivity implements View.OnClickListener {
    private static final String[] pageTitle = {"FEED","POPULAR","MEDIA"};
    ...
    private class ViewPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            return new ActivityStyle3Fragment(position);
        }
