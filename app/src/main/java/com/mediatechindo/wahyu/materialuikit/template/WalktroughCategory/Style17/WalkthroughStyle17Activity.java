package com.mediatechindo.wahyu.materialuikit.template.WalktroughCategory.Style17;
...
public class WalkthroughStyle17Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.walkthrough17_layout);
    ...
    private class ViewPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            return new WalkthroughStyle17Fragment(position);
        }
