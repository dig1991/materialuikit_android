...
public class ProfileStyle9Adapter extends RecyclerView.Adapter<ProfileStyle9Adapter.ItemViewHolder> implements ProfileStyle9ItemTouchAdapter{
    private final List<String> mItems = new ArrayList<>();
    private final ProfileStyle9OnStartDragListener mDragStartListener;
    private int count = 1;
    private Context context;

    public ProfileStyle9Adapter(Context ctx, ProfileStyle9OnStartDragListener dragStartListener) {
    ...
    public ItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_profile9, parent, false);
    ...
    public void onBindViewHolder(ItemViewHolder holder, int position) {
        ...
        String url = BuildConfig.IMAGE_URL + "profile/style-9/Profile-9-image.jpg";
        Glide.with(context)
                .load(url)
                .thumbnail(0.01f)
                .centerCrop()
