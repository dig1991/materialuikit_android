package com.mediatechindo.wahyu.materialuikit.template.LoginSignupCategory.Style8;
...
public class LoginSignupStyle8Activity extends AppCompatActivity implements View.OnClickListener {
    View bg;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bg = findViewById(R.id.loginsignup8_bg);

        String url = BuildConfig.IMAGE_URL + "login-signup/style-8/Login-Register-8-960.jpg";
