...
public class ProfileStyle22Activity extends AppCompatActivity implements View.OnClickListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.profile22_layout);
    ...
    public class ProfileStyle1Adapter extends FragmentPagerAdapter {
        ...
        public ProfileStyle1Adapter(FragmentManager fm){
            ...
            fragments.add(new ProfileStyle22Fragment());
            fragments.add(new ProfileStyle22Fragment());
            fragments.add(new ProfileStyle22Fragment());
            fragments.add(new ProfileStyle22Fragment());
        }
