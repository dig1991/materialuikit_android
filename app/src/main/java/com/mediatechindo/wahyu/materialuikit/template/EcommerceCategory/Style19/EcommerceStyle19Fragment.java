...
public class EcommerceStyle19Fragment extends Fragment {
    int wizard_page_position;

    public EcommerceStyle19Fragment(int position) {
        this.wizard_page_position = position;
    }

    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        int layout_id = R.layout.ecommerce19_fragment;
        View view = inflater.inflate(layout_id, container, false);

        String url = BuildConfig.IMAGE_URL + "ecommerce/style-19/Ecommerce-19.jpg";
