...
public class MenuNavigation14Adapter extends BaseAdapter{
    private Context context;
    private ArrayList<MenuNavigation14Model> menuData;
    private LayoutInflater mInflater;

    public MenuNavigation14Adapter(Context ctx, ArrayList<MenuNavigation14Model> data){
        context = ctx;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ViewHolder holder;
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.row_menunavigation14, null);
        ...
        if(menuData.get(position).isSelected()) {
            holder.buttonMenu.setBackgroundColor(ContextCompat.getColor(context, R.color.menuNavigation14menuSelected));
