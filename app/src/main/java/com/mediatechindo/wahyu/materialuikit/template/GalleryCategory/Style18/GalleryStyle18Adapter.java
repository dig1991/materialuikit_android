 ...
 */
public class GalleryStyle18Adapter extends RecyclerView.Adapter<GalleryStyle18Adapter.ItemViewHolder> {
    private static ArrayList<GalleryStyle18Model> dataList;
    private LayoutInflater mInflater;
    private Context context;
    private GalleryStyle18ClickListener clicklistener = null;

    public GalleryStyle18Adapter(Context ctx, ArrayList<GalleryStyle18Model> data) {
        context = ctx;
        dataList = data;
    ...
    public ItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_gallery18, parent, false);
    ...
    public void setClickListener(GalleryStyle18ClickListener listener) {
