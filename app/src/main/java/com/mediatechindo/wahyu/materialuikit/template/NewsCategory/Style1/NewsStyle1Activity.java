...
public class NewsStyle1Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View image = findViewById(R.id.news_style1_bg);
        String url = BuildConfig.IMAGE_URL + "news/style-1/news_1_background.png";
        loadImageRequest(image, url);

        updateIndicators(0);
    }

    private void loadImageRequest(final View bg, String url) {
        Glide.with(this)
                .load(url)
                .thumbnail(0.01f)
    ...
    private class ViewPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            return new NewsStyle1Fragment(position);
        }
