...
public class ActivityStyle18Activity extends AppCompatActivity implements View.OnClickListener{
    ArrayList<ActivityStyle18Model> rowListItem;
    ActivityStyle18Adapter rcAdapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity18_layout);
        ...
        String friend1Url = BuildConfig.IMAGE_URL + "profile/style-3/Profile-3-friend2.png";
        ...
        rcAdapter = new ActivityStyle18Adapter(this, rowListItem);
        rView.setAdapter(rcAdapter);
    }

    private ArrayList<ActivityStyle18Model> getAllItemList(){
        ArrayList<ActivityStyle18Model> allItems = new ArrayList<>();
        ActivityStyle18Model dt;

        dt = new ActivityStyle18Model("profile/style-3/Profile-3-friend3.png","Tony Ramirez", "Nice photo");
        allItems.add(dt);
        dt = new ActivityStyle18Model("profile/style-3/Profile-3-friend3.png","Ludwig", "I love how you took it on white");
        allItems.add(dt);
        dt = new ActivityStyle18Model("profile/style-3/Profile-3-friend2.png","Christina", "You're awesome!");
        allItems.add(dt);
        dt = new ActivityStyle18Model("profile/style-3/Profile-3-friend3.png","Remi Boucher", "Wow!");
        allItems.add(dt);
        dt = new ActivityStyle18Model("profile/style-3/Profile-3-friend3.png","Tony Ramirez", "Nice photo");
        allItems.add(dt);
        dt = new ActivityStyle18Model("profile/style-3/Profile-3-friend3.png","Ludwig", "I love how you took it on white");
