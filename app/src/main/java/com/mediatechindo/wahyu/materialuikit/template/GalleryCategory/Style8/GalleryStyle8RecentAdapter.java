 ...
 */
public class GalleryStyle8RecentAdapter extends RecyclerView.Adapter<GalleryStyle8RecentAdapter.ItemViewHolder> {
    private static ArrayList<GalleryStyle8RecentModel> dataList;
    private LayoutInflater mInflater;
    private Context context;

    public GalleryStyle8RecentAdapter(Context ctx, ArrayList<GalleryStyle8RecentModel> data) {
        context = ctx;
        dataList = data;
