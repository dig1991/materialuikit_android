package com.mediatechindo.wahyu.materialuikit.template.WalktroughCategory.Style15;
...
public class WalkthroughStyle15Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.walkthrough15_layout);
        ...
        viewPager.setPageMargin(getResources().getDimensionPixelOffset(R.dimen.walkthrough15_viewpager_margin));
        viewPager.setOffscreenPageLimit(4);

        View image = findViewById(R.id.activity_walkthrough_style15);
    ...
    private class ViewPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            return new WalkthroughStyle15Fragment(position);
        }
