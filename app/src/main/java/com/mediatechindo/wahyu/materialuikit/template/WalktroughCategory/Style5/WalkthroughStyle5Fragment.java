package com.mediatechindo.wahyu.materialuikit.template.WalktroughCategory.Style5;
...
public class WalkthroughStyle5Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        String url = BuildConfig.IMAGE_URL + "walkthrough/style-5/Welcome-5-960.png";
