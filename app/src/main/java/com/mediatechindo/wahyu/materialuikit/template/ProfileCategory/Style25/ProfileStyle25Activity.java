...
public class ProfileStyle25Activity extends AppCompatActivity implements View.OnClickListener {
    private static final String[] pageNum = {"359","289","317"};
    private static final String[] pageTitle = {"Stories","Photos","Videos"};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.profile25_layout);
    ...
    public class ProfileStyle1Adapter extends FragmentPagerAdapter {
        ...
        public ProfileStyle1Adapter(FragmentManager fm){
            ...
            fragments.add(new ProfileStyle25Fragment());
            fragments.add(new ProfileStyle25Fragment());
            fragments.add(new ProfileStyle25Fragment());
        }
        @Override
