package com.mediatechindo.wahyu.materialuikit.template.LoginSignupCategory.Style18;
...
public class LoginSignupStyle18Activity extends AppCompatActivity implements View.OnClickListener {
    View bg;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bg = findViewById(R.id.loginsignup18_bg);

        String url = BuildConfig.IMAGE_URL + "login-signup/style-18/Login-Register-18-960.jpg";
