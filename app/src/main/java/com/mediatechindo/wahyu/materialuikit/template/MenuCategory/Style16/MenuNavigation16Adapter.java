...
public class MenuNavigation16Adapter extends BaseAdapter{
    private Context context;
    private ArrayList<MenuNavigation16Model> menuData;
    private LayoutInflater mInflater;

    public MenuNavigation16Adapter(Context ctx, ArrayList<MenuNavigation16Model> data){
        context = ctx;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ViewHolder holder;
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.row_menunavigation16, null);
        ...
        if(menuData.get(position).isSelected()) {
            holder.buttonMenu.setBackgroundColor(ContextCompat.getColor(context, R.color.menuNavigation16menuSelected));
