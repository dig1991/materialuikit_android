package com.mediatechindo.wahyu.materialuikit.template.LoginSignupCategory.Style14;
...
public class LoginSignupStyle14Activity extends AppCompatActivity implements View.OnClickListener{
    private static final String[] pageTitle = {"SIGN UP","SIGN IN"};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.loginsignup14_layout);
        ...
        TabLayout tabLayout = (TabLayout) findViewById(R.id.tab_layout_loginsignup14);
        ViewPager viewPager = (ViewPager) findViewById(R.id.viewpager_loginsignup14);
    ...
    public class LoginSignup4Adapter extends FragmentPagerAdapter {
        ...
        public LoginSignup4Adapter(FragmentManager fm){
            ...
            fragments.add(new LoginSignupStyle14Fragment());
            fragments.add(new LoginSignupStyle14Fragment());
        }
        @Override
