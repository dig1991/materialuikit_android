...
public class ActivityStyle24Activity extends AppCompatActivity implements View.OnClickListener, ActivityStyle24ClickListener {
    ArrayList<ActivityStyle24Model> rowListItem;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActivityStyle24Adapter rcAdapter = new ActivityStyle24Adapter(this, rowListItem);
        rView.setAdapter(rcAdapter);
        rcAdapter.setClickListener(this);

    }

    private ArrayList<ActivityStyle24Model> getAllItemList(){
        ArrayList<ActivityStyle24Model> allItems = new ArrayList<>();
        ActivityStyle24Model dt;

        dt = new ActivityStyle24Model("profile/style-3/Profile-3-friend2.png","Christina","17:55",getResources().getString(R.string.lorem_ipsum2));
        allItems.add(dt);
        dt = new ActivityStyle24Model("profile/style-3/Profile-3-friend3.png","Remi Boocher","17:55",getResources().getString(R.string.lorem_ipsum3));
        allItems.add(dt);
        dt = new ActivityStyle24Model("profile/style-3/Profile-3-friend2.png","Christina","17:55",getResources().getString(R.string.lorem_ipsum2));
        allItems.add(dt);
        dt = new ActivityStyle24Model("profile/style-3/Profile-3-friend3.png","Remi Boocher","17:55",getResources().getString(R.string.lorem_ipsum3));
