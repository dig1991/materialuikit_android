...
public class ProfileStyle10Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.profile10_layout);
...
*/
    ...
    public class ProfileStyle1Adapter extends FragmentPagerAdapter {
        ...
        public ProfileStyle1Adapter(FragmentManager fm){
            ...
            fragments.add(new ProfileStyle10Fragment());
            fragments.add(new ProfileStyle10Fragment());
            fragments.add(new ProfileStyle10Fragment());
            fragments.add(new ProfileStyle10Fragment());
        }
