package com.mediatechindo.wahyu.materialuikit.template.WalktroughCategory.Style2;
...
public class WalkthroughStyle2Activity extends AppCompatActivity implements View.OnClickListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.walkthrough2_layout);
