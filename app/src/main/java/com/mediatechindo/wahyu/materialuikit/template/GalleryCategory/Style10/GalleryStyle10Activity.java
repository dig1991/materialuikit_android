...
public class GalleryStyle10Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.gallery10_layout);
    ...
    public void setFgFragment(int page, RelativeLayout fg){
        switch (page){
            case 0:
                fg1 = fg;
                break;
    ...
    private class ViewPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            return new GalleryStyle10Fragment(position);
        }
