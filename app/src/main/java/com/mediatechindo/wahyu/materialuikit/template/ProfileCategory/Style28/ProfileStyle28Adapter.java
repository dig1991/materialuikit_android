 ...
 */
public class ProfileStyle28Adapter extends RecyclerView.Adapter<ProfileStyle28Adapter.ItemViewHolder> {
    private static String[] dataList;
    private LayoutInflater mInflater;
    private Context context;
    private ProfileStyle28ClickListener clicklistener = null;

    public ProfileStyle28Adapter(Context ctx, String[] data) {
        context = ctx;
        dataList = data;
    ...
    public void setClickListener(ProfileStyle28ClickListener listener) {
