...
public class ActivityStyle12Activity extends AppCompatActivity implements View.OnClickListener{
    ArrayList<ActivityStyle12Model> rowListItem;
    ActivityStyle12Adapter rcAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView img1 = (ImageView) findViewById(R.id.headerTop);
        ...
        rcAdapter = new ActivityStyle12Adapter(this, rowListItem);
        rView.setAdapter(rcAdapter);

    }

    private ArrayList<ActivityStyle12Model> getAllItemList(){
        ArrayList<ActivityStyle12Model> allItems = new ArrayList<>();
        ActivityStyle12Model dt;

        dt = new ActivityStyle12Model("profile/style-3/Profile-3-friend3.png","Tony Ramirez", getResources().getString(R.string.lorem_ipsum2));
        allItems.add(dt);
        dt = new ActivityStyle12Model("profile/style-3/Profile-3-friend3.png","Ludwig", getResources().getString(R.string.lorem_ipsum2));
        allItems.add(dt);
        dt = new ActivityStyle12Model("profile/style-3/Profile-3-friend2.png","Christina", getResources().getString(R.string.lorem_ipsum2));
        allItems.add(dt);
        dt = new ActivityStyle12Model("profile/style-3/Profile-3-friend3.png","Remi Boucher", getResources().getString(R.string.lorem_ipsum2));
        allItems.add(dt);
        dt = new ActivityStyle12Model("profile/style-3/Profile-3-friend3.png","Tony Ramirez", getResources().getString(R.string.lorem_ipsum2));
        allItems.add(dt);
        dt = new ActivityStyle12Model("profile/style-3/Profile-3-friend3.png","Ludwig", getResources().getString(R.string.lorem_ipsum2));
