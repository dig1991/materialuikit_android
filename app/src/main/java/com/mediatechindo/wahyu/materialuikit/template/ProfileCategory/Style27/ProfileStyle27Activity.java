...
public class ProfileStyle27Activity extends AppCompatActivity implements View.OnClickListener, ProfileStyle27OnStartDragListener {
    private ItemTouchHelper mItemTouchHelper;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.profile27_layout);
        ...
        ProfileStyle27Adapter adapter = new ProfileStyle27Adapter(this, this);
        ...
        ItemTouchHelper.Callback callback = new ProfileStyle27ItemTouchCallback(adapter);
