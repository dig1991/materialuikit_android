...
public class WalkthroughStyle7Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.walkthrough7_layout);
    ...
    private class ViewPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            return new WalkthroughStyle7Fragment(position);
        }
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.btnSignIn:
//                Snackbar.make(view, "Button Sign up clicked!", Snackbar.LENGTH_SHORT).setAction("Action", null).show();
