 ...
 */
public class ActivityStyle20Adapter extends RecyclerView.Adapter<ActivityStyle20Adapter.ItemViewHolder> {
    private static ArrayList<ActivityStyle20Model> dataList;
    private LayoutInflater mInflater;
    private Context context;

    public ActivityStyle20Adapter(Context ctx, ArrayList<ActivityStyle20Model> data) {
        context = ctx;
        dataList = data;
    ...
    public ItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_activity20, parent, false);
