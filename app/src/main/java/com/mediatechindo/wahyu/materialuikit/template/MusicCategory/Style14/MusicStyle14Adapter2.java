 ...
 */
public class MusicStyle14Adapter2 extends RecyclerView.Adapter<MusicStyle14Adapter2.ItemViewHolder> {
    private static ArrayList<MusicStyle14Model> dataList;
    private LayoutInflater mInflater;
    private Context context;
    private MusicStyle14ClickListener clicklistener = null;

    public MusicStyle14Adapter2(Context ctx, ArrayList<MusicStyle14Model> data) {
        context = ctx;
        dataList = data;
