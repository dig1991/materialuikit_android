 ...
 */
public class GalleryStyle2Adapter1 extends RecyclerView.Adapter<GalleryStyle2Adapter1.ItemViewHolder> {
    private static ArrayList<GalleryStyle2Model> dataList;
    private LayoutInflater mInflater;
    private Context context;
    private GalleryStyle2ClickListener clicklistener = null;

    public GalleryStyle2Adapter1(Context ctx, ArrayList<GalleryStyle2Model> data) {
        context = ctx;
        dataList = data;
    ...
    public ItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_gallery1big, parent, false);
