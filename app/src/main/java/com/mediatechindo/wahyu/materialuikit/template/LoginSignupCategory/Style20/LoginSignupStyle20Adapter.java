...
public class LoginSignupStyle20Adapter extends RecyclerView.Adapter<LoginSignupStyle20Adapter.ItemViewHolder> implements LoginSignupStyle20ItemTouchAdapter {
    private final List<String> mItems = new ArrayList<>();
    private final LoginSignupStyle20OnStartDragListener mDragStartListener;
    private int count = 1;
    private Context context;

    public LoginSignupStyle20Adapter(Context ctx, LoginSignupStyle20OnStartDragListener dragStartListener) {
    ...
    public ItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_loginsignup20, parent, false);
